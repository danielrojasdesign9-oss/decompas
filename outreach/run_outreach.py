"""CLI del outreach de DeCompas.

Ejemplo:
  python outreach/run_outreach.py --scored data/scored_20260801_001002.json \
      --base-url https://decompas.netlify.app/diagnostico --out-dir out
"""
...
def main() -> int:
    ...
    p.add_argument("--base-url", default="https://decompas.netlify.app/diagnostico",
